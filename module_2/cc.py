...
def get_recommendation(title,cosine_sim_mat,df,num_of_rec=10):
	...
	final_recommended_courses = result_df[['course_title','similarity_score','url','price','num_subscribers','level']]
			...
			if search_term is not None:
				try:
					...
					for row in results.iterrows():
						...
						rec_num_sub = row[1][5]
						rec_level=row[1][4]
						stc.html(result_temp.format(rec_title,rec_score,rec_url,rec_url,rec_price,rec_level,rec_num_sub),height=350)
